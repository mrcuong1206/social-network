...
exports.reactMess = async (req, res) => {
  try {
    const { messId, react } = req.body;
    const check = await React.findOne({
      messRef: messId,
      reactBy: mongoose.Types.ObjectId(req.user.id),
    });
...
exports.getReactsPost = async (req, res) => {
  try {
    const reactsArray = await React.find({ postRef: req.params.id }).populate(
      "reactBy",
      "first_name last_name id picture friends requests"
    );
...
exports.getReactsComment = async (req, res) => {
  try {
    ...
    }).populate("reactBy", "first_name last_name id picture friends requests");
...
exports.getReactsMess = async (req, res) => {
  try {
    const reactsArray = await React.find({ messRef: req.params.id }).populate(
      "reactBy",
      "first_name last_name id picture friends requests"
    );
