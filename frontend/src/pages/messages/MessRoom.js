...
export default function MessRoom_Screen({
  message,
  user,
  socket,
  showChatRoom,
              ...
              >
                {message.image && (
                  <>
                    {" "}
                    <div
                      className="mess_img_wrap"
                      onClick={() => setVisiblePhotoDetail(message.image)}
                    >
                  ...
                  <>
                    <div
                      ...
                      style={{
                        marginRight: "8px",
                        width: "fit-content",
                        background: showChatRoom?.color,
                      }}
                    >
                      <div className="comment_text" style={{ color: "#fff" }}>
                        {message.message}
                      </div>
                    </div>
                  </>
